  ...
  return (
    <div className="d-flex h-100">
        ...
        <div className="d-flex flex-column align-items-center py-3 bg-dark" style={{ width: '50px', backgroundColor: '#1e1e1e' }}>
            <div 
                className={`mb-4 cursor-pointer ${view === 'componentes' ? 'text-white' : 'text-secondary'}`} 
            ...
            <div 
                className={`mb-4 cursor-pointer ${view === 'sidebar' ? 'text-white' : 'text-secondary'}`} 
            ...
            {view === 'componentes' ? (
                <>
                    ...
                    <div className="row g-2">
                        ...
                        <ToolButton 
                            refProp={(ref) => ref && connectors.create(ref, <Navbar />)}
