// components/user/FloraPageTemplate.jsx
// Plantilla completa de página de Flora
...
export const FloraPageTemplate = ({
  showNavbar = true,
  showHero = true,
  showCards = true,
  // Navbar props
  ...
  return (
    ...
    >
      <Element id="flora-container" is={BackgroundImageContainer} padding={0} background="#000000" canvas>
        {/* Navbar */}
        {showNavbar && (
          <Element is={Navbar}
            id="flora-navbar"
...
const FloraPageTemplateSettings = () => {
          ...
          content: (
            <div className="d-grid gap-3">
              <div>
                ...
                />
                <small className="text-muted">Pega aquí el link o URL de la imagen. La imagen aparecerá detrás del título "Flora"</small>
              </div>
              {props.heroImageUrl && (
                <div className="mt-2">
...
FloraPageTemplate.craft = {
  displayName: 'Página de Flora Completa',
  props: {
    showNavbar: true,
    showHero: true,
    showCards: true,
  ...
  related: {
    settings: FloraPageTemplateSettings
  }
};
