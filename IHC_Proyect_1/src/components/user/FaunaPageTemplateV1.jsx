// components/user/FloraPageTemplateV1.jsx
// Plantilla completa de página de Flora - Variante 1: Card grande + 2 pequeñas
...
export const FloraPageTemplateV1 = ({
  showNavbar = true,
  showHero = true,
  showCards = true,
  // Navbar props
  ...
  cards = JSON.stringify([
    {
      id: 1,
      image: '',
      title: 'Nueva "rana murciélago" descubierta en el Amazonas',
      subtitle: 'llamada así en honor a Ozzy Osbourne',
      link: '#',
    },
    {
      id: 2,
      image: '',
      title: '¿Por qué importa la deforestación?',
      subtitle: 'Descubre que podemos hacer para detenerla.',
      link: '#',
    },
    {
      id: 3,
      image: '',
      title: 'El amazonas alberga el 10% de la biodiversidad mundial',
      subtitle: '',
      link: '#',
    },
  ]),
  ...
  return (
    ...
    >
      <Element id="flora-v1-background" is={BackgroundImageContainer} padding={0} background="#000000" canvas>
        {showNavbar && (
          <Element is={Navbar}
            id="flora-v1-navbar"
        ...
        {showCards && (
          <div style={{
            ...
            <div style={{
              ...
              {/* Grid: Card grande izquierda + 2 pequeñas derecha */}
              <div style={{
                flex: 1,
                display: 'grid',
                ...
                {parsedCards[0] && (
                  <Element
                    is={FeatureCard}
                    id={`flora-v1-card-${parsedCards[0].id || 0}`}
                ...
                {/* Card pequeña 1 (arriba derecha) */}
                {parsedCards[1] && (
                  <Element
                    is={FeatureCard}
                    id={`flora-v1-card-${parsedCards[1].id || 1}`}
                ...
                {/* Card pequeña 2 (abajo derecha) */}
                {parsedCards[2] && (
                  <Element
                    is={FeatureCard}
                    id={`flora-v1-card-${parsedCards[2].id || 2}`}
...
const FloraPageTemplateV1Settings = () => {
          ...
          content: (
            <div className="d-grid gap-3">
              <div>
                ...
                />
                <small className="text-muted">Formato: Array JSON con objetos {`{id, image, title, subtitle?, link}`}</small>
              </div>
              <div>
...
FloraPageTemplateV1.craft = {
  displayName: 'Página de Flora V1 (Card Grande + 2 Pequeñas)',
  props: {
    showNavbar: true,
    showHero: true,
    showCards: true,
  ...
  related: {
    settings: FloraPageTemplateV1Settings
  }
};
