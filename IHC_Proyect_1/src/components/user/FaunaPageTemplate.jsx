// components/user/FaunaPageTemplate.jsx
// Plantilla completa de página de Fauna
...
export const FaunaPageTemplate = ({
  showNavbar = true,
  showHero = true,
  showCards = true,
  // Navbar props
  ...
  cards = JSON.stringify([
    {
      ...
      title: '¿Cuándo los gatos se volvieron domésticos?',
      link: '#',
    },
    {
      id: 2,
      image: 'https://placehold.co/400x300',
      title: 'Delfines adultos orinan en el aire',
      link: '#',
    },
    {
      id: 3,
      image: 'https://placehold.co/400x300',
      title: 'Extraña oruga con tentáculos en erupción',
      link: '#',
    },
    {
      id: 4,
      image: 'https://placehold.co/400x300',
      title: 'Se descubren nuevas especies cada dos días',
      link: '#',
    },
    {
      id: 5,
      image: 'https://placehold.co/400x300',
      title: 'rana nombrada en honor a monstruo mítico',
      link: '#',
    },
    {
      id: 6,
      image: 'https://placehold.co/400x300',
      title: 'Perezosos, manatíes y otros animales salvajes rescatados del turismo en la Amazonia',
      link: '#',
    },
    {
      id: 7,
      image: 'https://placehold.co/400x300',
      title: 'Misterioso animal del Amazonas visto con vida por primera vez en 80 años',
      link: '#',
    },
    {
      id: 8,
      image: 'https://placehold.co/400x300',
      title: 'incendio en el amazonas para los animales salvajes',
      link: '#',
    },
  ]),
  cardsColumns = 3,
  ...
  return (
    ...
    >
      <Element id="fauna-background" is={BackgroundImageContainer} padding={0} background="#000000" canvas>
        {showNavbar && (
          <Element is={Navbar}
            id="fauna-navbar"
            ...
            navItems={JSON.stringify([
              ...
              { label: "Fauna", actionType: "section", sectionName: "fauna", active: true },
      ...
      {selected && id !== 'ROOT' && (
        ...
        >
          ...
          <i
            ...
            onClick={(e) => {
              e.stopPropagation();
              const { data: { type, props } } = node;
              add(createNode(Element, { is: type, ...props }), 'parentId');
            }}
          />
          <i
...
const FaunaPageTemplateSettings = () => {
          ...
          content: (
            <div className="d-grid gap-3">
              <div>
                ...
                />
                <small className="text-muted">Pega aquí el link o URL de la imagen. La imagen aparecerá detrás del título "Fauna"</small>
              </div>
              {props.heroImageUrl && (
                <div className="mt-2">
...
FaunaPageTemplate.craft = {
  displayName: 'Página de Fauna Completa',
  props: {
    showNavbar: true,
    showHero: true,
    showCards: true,
    ...
    heroHeight: 400,
    cards: JSON.stringify([
      { id: 1, image: 'https://placehold.co/400x300', title: '¿Cuándo los gatos se volvieron domésticos?', link: '#' },
      { id: 2, image: 'https://placehold.co/400x300', title: 'Delfines adultos orinan en el aire', link: '#' },
  ...
  related: {
    settings: FaunaPageTemplateSettings
  }
};
